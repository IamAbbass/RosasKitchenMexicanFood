                            ...
                            <header>
                                <div class="row">
                                    ...
                                    <div class="col company-details">
                                        ...
                                        <div style="font-size: 14px;"><i class="lni lni-whatsapp"></i> <a href="https://bit.ly/sabzify-wa" target="_blank">{{ auth()->user()->business->phone }}</a></div>
                                        <div style="font-size: 14px;"><i class="lni lni-play-store"></i> <a href="https://play.google.com/store/apps/details?id=com.zed.sabzify" target="_blank">SABZIFY App.</a></div>
