                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-select" name="type">
                                            <option value="" {{ (old("type") == null ? "selected":"") }}>Default</option>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="number" name="sale" value="{{ old('sale',0) }}" class="form-control" step=".01">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">* Discount</label>
                                        <input type="number" name="discount" value="{{ old('discount', '0') }}" class="form-control" step=".01">
                                    </div>
                                    <div class="col-md-1">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-select" name="is_highlight">
                                            <option value="0" {{ (old('is_highlight') == 0 ? "selected":"") }}>Yes</option>
                                            <option value="1" {{ (old('is_highlight') == 1 ? "selected":"") }}>No</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">Is Available</label>
                                        <select class="form-select" name="is_available">
                                            <option value="1" {{ (old('is_available') == 1 ? "selected":"") }}>Active</option>
                                            <option value="0" {{ (old('is_available') == 0 ? "selected":"") }}>Inactive</option>
                                        </select>
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">* Purchase Price</label>
                                        <input type="number" name="purchase" value="{{ old('purchase', '0') }}" class="form-control" step=".01">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">* Purchased Quantity</label>
                                        <input type="number" name="purchased_qty" value="{{ old('quantity', '0') }}" class="form-control" step=".01">
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mt-1"> <span class="input-group-text">Description</span>
