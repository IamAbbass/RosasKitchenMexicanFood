                ...
                <div class="row">
                    <div class="col-lg-12">
                            <div class="border border-3 p-3 rounded">
                                <form action="/whatsapp" method="POST" enctype="multipart/form-data" target="_blank">
                                @csrf
                                    <div class="row g-2">
                                        <div class="col-md-12">
                                            <label class="form-label">* WhatsApp#</label>
                                            <input class="form-control" type="text" name="number" value="{{ old('number') }}" placeholder="923347229439" autocomplete="off" autofocus>
                                        </div>
                                        <div class="col-md-12">
